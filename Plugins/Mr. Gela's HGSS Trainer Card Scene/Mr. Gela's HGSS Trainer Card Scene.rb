...
class Player < Trainer
  ...
  alias initialize_hgsstc initialize
  def initialize(name, trainer_type)
      initialize_hgsstc(name, trainer_type)
    super
    @score = 0
    @stars = 0
    @halloffame = []
...
class PokemonTrainerCard_Scene
  ...
  def pbDrawTrainerCardFront
    ...
    textPositions = [
       [_INTL("NAME"), 332 - 60, 70 - 16, 0, base, shadow],
       [$player.name, 302 + 89 * 2, 70 - 16, 1, base, shadow],
       [_INTL("ID No."), 32, 70 - 16, 0, base, shadow],
    ...
    textPositions = [
      [_INTL("Press the Use Button to flip the card."), 16, 70 + 280, 0, Color.new(216, 216, 216), Color.new(80, 80, 80)]
    ]
  ...
  def pbDrawTrainerCardBack
    ...
    textPositions = [
      [_INTL("HALL OF FAME DEBUT"), 32, 70 - 48, 0, base, shadow],
