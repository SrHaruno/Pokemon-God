...
#===============================================================================
# Module housing additional bitmap drawing components.
module Bitmaps
  # Class used to draw polygons onto bitmaps
  class Polygon < ::Bitmap
    # Creates a blank polygon bitmap with an empty vertex list.
    ...
    # @param x [Integer] vertex x coordinate
    # @param y [Integer] vertex y coordinate
    # @return [void]
    def add_vertex(x:, y:)
      @vertices << [x, y]
    end
    ...
    # @param percent [Numeric] distance from center as a fraction of bitmap radius
    # @param angle [Integer] angle from center in degrees
    # @return [void]
    ...
    # @param color [Color] fill color for the polygon
    # @return [void]
    ...
    # @param x [Integer] point x coordinate
    # @param y [Integer] point y coordinate
    # @return [Boolean] true if the point lies inside the polygon
